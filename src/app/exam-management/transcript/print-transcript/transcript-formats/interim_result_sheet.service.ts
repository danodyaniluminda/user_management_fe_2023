...
export class Interim_result_sheetService {
              ...
              new docx.Paragraph({
                ...
                children: [
                  new TextRun({
                    font:"Book Antiqua",
                    size:20,
                    text: String(courseDetails[j].gradeGpValue),
                  }),
                ]
              })
...
if (gg.coursejsonDataEnglish.length === 0) {
  ...
  this.additionalRequirementsTable=this.generateEnglishTable(gg.coursejsonDataEnglish);
}
...
//const dateString = currentDate.toLocaleDateString();
  ...
  // gpa,
   this.createSubHeadingSecond("Key to Grades/Status, Grade Point Values and Mark Ranges:"),
